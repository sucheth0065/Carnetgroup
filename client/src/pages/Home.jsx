    ...
    <div>
      ...
      <div className="bg-zinc-950  flex justify-between items-center p-3">
        <div className="flex-col ml-6 item-center">
          ...
          <h4 className="w-3/4 font-medium text-white">
      ...
      <div className="bg-orange-400 h-40 flex justify-center items-center">
        <h1 className="text-center text-white text-2xl font-bold mr-5">
          Search Our Projects
        </h1>
        <button className="border border-gray-600 rounded-md px-4 py-2 bg-white text-gray-600 font-semibold hover:bg-gray-100 transition duration-300">
          Projects
        </button>
      </div>
